...
<footer id="footer">
  ...
  <div class="footer-top">
    <div class="container">
      ...
      <div class="col-lg-3 col-md-6">
        <h3>SMK Assa'idiyyah Kudus</h3>
        <p>
          Jln. Mbah Hamzah Krapyak Desa Kirig Kec. Mejobo Kab, Kudus<br>
          <strong>Phone:</strong> 081908267202<br>
          <strong>Email:</strong> esemkaasaa@gmail.com<br>
        </p>
      </div>
...
<div class="container">
  ...
  <div class="copyright-wrap d-md-flex py-4">
    <div class="me-md-auto text-center text-md-start">
      <div class="copyright">
        &copy; Copyright <strong><span>smk assa'idiyyah kudus</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">TuturBrilliana</a>
      </div>
    </div>
